...
//        $limit = $this->getParameter('nb_posts_per_page');
        ...
        return $this->render('film/films.html.twig', compact('films'));
    }

    #[Route('/series', name: 'app_series')]
    public function series(): Response
    {
        return $this->render('film/series.html.twig');
    }
    ...
    public function films_show(FilmRepository $filmRepository, ?int $id): Response
    {
        ...
        return $this->render('film/film_show.html.twig', compact('film'));
    }

    #[Route('/serie/{id}', name: 'app_serie_show')]
    public function series_show(): Response
    {
        return $this->render('film/serie_show.html.twig');
    }
...
//        $film = $filmRepository->find($id);
    ...
    public function find()
    {
        ...
        $films = [];
//        dd($form);
        return $this->render('film/recherche.html.twig', compact('form', 'films'));
    }
